...
function EditProfile() {
  ...
  return (
    <div>
      ...
      {/* Avatar card — tap to open picker */}
      <div className="mt-6 flex items-center gap-4 p-4 rounded-3xl glass-strong shadow-card">
        ...
        >
          ...
          />
          {/* Hover/tap overlay */}
          <div className="absolute inset-0 bg-black/0 group-hover:bg-black/35 transition grid place-items-center">
            {avatarUploading ? (
              <Loader2 className="h-5 w-5 text-white animate-spin opacity-0 group-hover:opacity-100 transition" />
            ) : (
